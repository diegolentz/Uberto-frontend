...
// se obtiene el id del sessionStorage y obtengo la entidad correspondiente, desp veo si es driver o travel
// si es driver, muestro el cardDriver con el tipo true, si es travel, muestro el cardDriver con el tipo false
export const Home = () => {
